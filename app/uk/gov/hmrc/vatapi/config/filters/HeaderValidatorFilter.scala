...
import uk.gov.hmrc.vatapi.config.HeaderValidatorFilter.{Status, acceptHeaderValidationRules}

import scala.concurrent.{ExecutionContext, Future}

class HeaderValidatorFilter@Inject()(implicit val mat: Materializer, ec: ExecutionContext) extends Filter {
