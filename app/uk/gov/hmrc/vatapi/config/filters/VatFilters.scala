...
class VatFilters @Inject()(defaultFilters: MicroserviceFilters,
  ...
  DefaultHttpFilters(
    defaultFilters.filters :+ emptyResponseFilter :+ headerValidatorFilter :+ setContentTypeFilter :+ setXContentTypeOptionsFilter: _*)